...
module.exports = {
  info: {
      name: "love",
      description: "Mostra seu amor por outro membro do servidor",
      usage: "",
      aliases: ["amor", "quedinha"],
  },
  ...
  {//exportando o comando como ship
    ...
    const loveLevel = "█".repeat(loveIndex) + ".".repeat(10 - loveIndex);
      ...
      if(amor > 90) {
        desc = (":sparkling_heart: Hmmm, será que nós temos um novo casal aqui? :sparkling_heart:\n``"+membro1.user.username+"``\n``"+membro2.user.username+"``\n:heart: ``"+nomeship+"`` São mais perfeito do que eu! :heart:");
      } else if(amor >= 70) {
